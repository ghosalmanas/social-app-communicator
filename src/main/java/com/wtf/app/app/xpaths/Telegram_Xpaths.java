...
public class Telegram_Xpaths implements XPathInterfaceWATG {
	...
	private final String MESSAGE_TO_EACH_GROUP_TO_ADVERTISE_FOR_SELF_SKILLSET_FOR_PROXY_SUPPORT=
			...
			"I am a **Fullstack and Backend Proxy and Support** Person with 15+ Years of **Expertise IT Industry Experience** "
			...
			+(Keys.SHIFT)+(Keys.ENTER)+(Keys.SHIFT)
			+ "I help in the following techStack :"
	        +"** JAVA 8,17,21, Spring Boot, Microservices, Kafka, Angular, Javascript, React, AWS, Docker, Kubernetes, Redis, DevOps, CICD** "
			+(Keys.SHIFT)+(Keys.ENTER)+(Keys.SHIFT)
			+ "Method : - **Prompting & Transcript with Premium Otter** with Screen Control App for live coding."
			//+(Keys.SHIFT)+(Keys.ENTER)+(Keys.SHIFT)
