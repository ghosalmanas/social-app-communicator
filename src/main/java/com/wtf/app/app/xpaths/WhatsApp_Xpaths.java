...
public class WhatsApp_Xpaths implements XPathInterfaceWATG {
	...
	private final String MESSAGE_TO_EACH_GROUP_TO_ADVERTISE_FOR_SELF_SKILLSET_FOR_PROXY_SUPPORT=
			...
			" _NL_ "
			+"*>* I am a *Fullstack Proxy and Support* Person with 15+ Years of *Expertise IT Industry Experience* "
			...
			//+(Keys.SHIFT)+(Keys.ENTER)+(Keys.SHIFT)+
			+" _NL_ "
	        +"*>* JAVA 8,11,17,21, Spring Boot, Spring AI, Microservices, Kafka, Angular, React, AWS, Docker, Kubernetes, Redis*, JPA, Data Structures and Algorithms "
			...
			+ "*>* Method: - *Prompting & Transcript with Premium Otter* with Screen Control for live coding.";
			//+(Keys.SHIFT)+(Keys.ENTER)+(Keys.SHIFT)
			//+(Keys.SHIFT)+(Keys.ENTER)+(Keys.SHIFT)
	...
	private final String SPAN_DATA_TESTID_SEND = "//span[@data-icon='send']";
	...
	private final String BACK_ARROW__BESIDE_MAGNIFYING_GLASS_SEARCH_BUTTON_XPATH = "//button[@aria-label='Chat list']";
	...
	private final String CLEAR_SEARCH_OF_PREVIOUS_GROUP_AFTER_SELECTION ="//span[@data-icon='x-alt']";
