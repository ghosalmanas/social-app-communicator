...
import com.wtf.app.app.impls.WA_D_ArchiveAllSupportGroups;
...
public class WA_D_Archieve_Support_Groups extends WhatsappRunnerParent {

	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		XPathInterfaceWATG xPathInterface= new WhatsApp_Xpaths();
		WhatsappCommonUtils instance = new WA_D_ArchiveAllSupportGroups(xPathInterface.getBASE_URL(),SocialType.WHATSAPP);
		execute(instance);
