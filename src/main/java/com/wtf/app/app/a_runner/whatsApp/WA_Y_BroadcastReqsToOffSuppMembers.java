...
public class WA_Y_BroadcastReqsToOffSuppMembers {
	...
	private static final String MESSAGE_TO_SUPPORT_CANDIDATE_LIST_JD_REQUIREMENT="Hi, We have Support Freelancing Requirement for following Tech Stack"
		...
		public static void main(String[] args) throws InterruptedException, IOException {
			...
			//new WAContactExtractorAndMsgSender(xPathInterfaceWatg).updateContactsOrBroadcastMessages(fileNameToReadAllGroupNames, needToSendMessageToEveryGroup, broadcastMessageToSend);
