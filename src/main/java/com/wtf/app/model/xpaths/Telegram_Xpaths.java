...
public class Telegram_Xpaths implements XPathInterfaceWATG {
	...
	private final String MESSAGE_TO_EACH_GROUP_TO_ADVERTISE_FOR_SELF_SKILLSET_FOR_PROXY_SUPPORT=
			...
			"I am a **Fullstack and Backend Proxy and Support** direct individual Person with 16+ Years of **Expertise IT Industry Experience**. WhatsApp: **+918274848227**"
			+" _NL_ "
					+" _NL_ "
			...
			+ "** **100% GUARANTEED, SAFE AND SECURE** **. " +
					" _NL_ " +
					" _NL_ " +
			"I take calls from _**USA,Canada,UK and India since last 9+**_ years in Fullstack and Backend profiles in below areas: "
			+" _NL_ "
			...
			+" _NL_ "
					+" _NL_ "
			+ "**Process** : - Prompting & Transcript with **Otter Premium** with **100% _IN-VISIBLE and UN—TRACEABLE_ Screen Control apps** for live coding. WhatsApp: **+918274848227**";
